import KawahIjen from "../../assets/explore/kawah-ijen-post.jpg";
import JatimPark from "../../assets/explore/jawa-timur-park-2.jpg";
...
export const exploreData = [
    ...
    {
        id: 5,
        name: "Kusuma Argowisata",
        location: "Batu, Jawa Timur",
        image: Kusuma,
        rating: 430,
        categories: ["Argowisata", "Rekreasi & Santai"],
        description:
            "Kusuma Agrowisata adalah destinasi wisata yang terletak di Kota Batu, Jawa Timur, yang menawarkan pengalaman unik dalam menjelajahi kebun buah-buahan tropis. Di sini, pengunjung dapat menikmati keindahan alam serta belajar lebih banyak tentang budidaya buah-buahan yang khas dari Jawa Timur.\n",
        kategori: "Dewasa",
        priceAdult: "Rp. 50.000",
        kategori2: "Anak-Anak ( 3-12 Tahun )",
        priceChild: "Rp 30.000",
        link: "https://maps.app.goo.gl/mWYpng1Ctqnrazx99",
        price: " Masuk",
        expect:
            "Pengunjung dapat mengikuti tur yang dipandu oleh petani lokal untuk menjelajahi kebun buah-buahan yang subur. Di sini, mereka akan belajar tentang proses budidaya, pemeliharaan, dan panen buah-buahan tropis seperti apel, stroberi, dan jeruk.\n" +
            "Selain tur kebun buah, terdapat juga berbagai aktivitas menyenangkan lainnya seperti memetik buah langsung dari pohon, bermain di taman bermain anak, dan berbelanja produk lokal seperti jajanan dan suvenir.\n",
        addInfo:
            "Kusuma Agrowisata buka setiap hari dari pukul 08.00 pagi hingga 17.00 sore.\n" +
