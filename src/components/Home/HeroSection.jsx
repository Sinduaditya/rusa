...
function HeroSection() {
    return (
        <>
            {/*[1150px]*/}
            <div className="lg:h-[500px] relative bg-white bg-cover bg-center mx-auto rounded-2xl h-screen"
                 style={{backgroundImage: `url(${Hero})`}}>
                <div
                    className="text-center w-full h-full bg-gradient-to-b from-midnight/10 to-[#000000]/80 rounded-2xl flex justify-center items-center">
                    <div className="max-w-md">
                        <div
                            className="lg:absolute -my-10 md:relative lg:bottom-[160px] text-center text-white items-center sm:bottom-24 sm:left-14">
