    ...
    return (
        <>
            <div className="relative z-10 border-transparent border">
                {/* Review - Start */}
                <div className="justify-center grid gap-4 font-poppins max-w-screen-lg mx-auto my-12 px-12 py-6  md:justify-between bg-glass bg-opacity-70 rounded-[64px] border-2 border-white border-opacity-50 backdrop-blur-4xl">
