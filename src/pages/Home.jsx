...
const Home = () => {
    return (
        <>
            <div
                className="mx-auto max-w-screen-xl px-4 sm:px-6 lg:px-8 overflow-hidden relative font-Inter">
                {/*header*/}
                <div className="pt-20">
                    ...
                    <div className="absolute bottom-44 left-16 text-white flex items-center">
                    ...
                    <h1 className="absolute bottom-32  left-16 text-white text-5xl font-bold">Kawah
                        Ijen</h1>
                </div>
                {/*End header*/}

                <div className="hidden md:block bg-white rounded-lg mx-28 p-4 relative -mt-10  justify-center shadow">
                    <div className="grid grid-cols-4 gap-4">
                        ...
                        <div className="flex">
                            ...
                            <div className="pt-3 pl-2">
                                ...
                                <p className="text-sm font-normal">Destinasi Wisata</p>
                            </div>
                        </div>
                        <div className="flex">
                            ...
                            <div className="pt-3 pl-2">
                                ...
                                <p className="text-sm font-normal">Destinasi Kota</p>
                            </div>
                        </div>
                        <div className="flex">
                            ...
                            <div className="pt-3 pl-2">
                                ...
                                <p className="text-sm font-normal">Destinasi Kuliner</p>
                            </div>
                        </div>
                    </div>
                </div>
