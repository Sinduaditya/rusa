    ...
    return (
        <>
            <div className="bg-bluelight relative z-10">
                <div
                    className="absolute -left-[450px] top-32  md:w-[900px] md:h-[900px]  w-[500px] h-[500px]  z-[-1] bg-yellow rounded-[100%] mix-blend-multiply  filter blur-2xl opacity-15 animate-blob animation-delay-100"></div>
                <div
                ...
                <div className="mx-auto max-w-screen-xl px-4 font-poppins pt-[20px] ">
                    ...
                    <div
                        ...
                        <div className="hero-content text-center flex flex-col justify-center">
                            <div className="">
                                <h1 className="text-6xl font-bold text-white">Tentang DolanRek.</h1>
                            </div>
                        </div>
                    </div>
                    {/*End Humburger*/}
                    {/*  About Start*/}
                    <section
                        className="overflow-hidden bg-transparent mt-[50px] pt-10 pb-12 lg:pt-[40px] lg:pb-[90px] font-poppins">
