                    ...
                    <section className="flex items-center py-10 bg-transparent lg:py-4 font-poppins">
                        <div className="justify-center flex-1 max-w-6xl px-4 py-4 mx-auto text-left lg:py-2">
                            {filteredData.map((item, index) => (
                                <Link
                                    key={index}
                                    to={`/detail-stories/${item.id}`}
                                >
                                    <article className="mx-auto my-2 flex max-w-md flex-col  px-4  md:max-w-5xl md:flex-row  p-3 rounded-3xl  md:items-center">
                                        <div className="shrink-0 md:mr-8 md:max-w-xs">
                                            <img
                                                className="rounded-2xl w-[200px] h-[190px]  object-cover"
                                                src={item.image}
                                                alt={item.title}
                                            />
                                        </div>
                                        <div className="py-4 sm:py-8">
                                            ...
                                            <p className="mb-2 block text-2xl font-semibold text-gray-700">
                                                {item.title}
                                            </p>
